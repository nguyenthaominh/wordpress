...
class Editor extends Component {
  ...
  togglePreview = () => {
    ...
    if (!this.state.isEditing) {
      debouncedSpeak(__("Hiển thịProducts block preview.", "woocommerce"));
    }
  };
  ...
  getInspectorControls = () => {
    ...
    return (
      <InspectorControls key="inspector">
        <PanelBody title={__("Layout Settings", "woocommerce")} initialOpen>
          <GridLayoutControl
            columns={columns}
            rows={rows}
      ...
      <BlockControls>
        <ToolbarGroup
          controls={[
            {
              icon: "edit",
              title: __("Edit the layout of each product", "woocommerce"),
