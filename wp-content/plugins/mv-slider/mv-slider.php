 ...
 if(! class_exists('MV_Slider')){
  class MV_Slider{
    ...
    public function add_menu(){
      ...
      add_submenu_page(
        'mv_slider_admin',
        esc_html__('Manage Sliders','mv-slider'),
        esc_html__('Manage Sliders','mv-slider'),
        'manage_options',
    ...
    public function mv_slider_settings_page(){
      ...
      if(isset($_GET['settings-updated'])){
        add_settings_error('mv_slider_options','mv_slider_message',esc_html__('Settings Saved'), 'success');
      }
    ...
    public function register_scripts(){
      ...
      wp_register_style('mv-slider-main-css', MV_SLIDER_URL. 'assets/css/frontend.css', array(), MV_SLIDER_VERSION, 'all');
    }
